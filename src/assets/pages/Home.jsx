        ...
        <div className="w-full">
            ...
            <section id="about" className="px-4 py-12 md:p-16 flex items-center justify-center min-h-screen">
                <div className="bg-[#FBF5F3] text-[#000807] p-6 md:p-12 rounded-xl shadow-2xl w-full max-w-4xl text-center">
                    ...
                    <p className="text-sm md:text-base leading-relaxed space-y-4">
                        <span className="block"><strong>Hey, ik ben Chris</strong> – een enthousiaste front-end developer met een passie voor design en technologie.</span>
            ...
            <section id="skills" className="px-4 py-12 md:p-16 min-h-screen w-full flex items-center justify-center">
                <div className="flex flex-col md:flex-row items-start justify-center gap-10 w-full max-w-6xl">
                    <div className="w-full md:w-1/2">
                        <div className="grid grid-cols-2 sm:grid-cols-3 gap-6">
                            {frontendSkills.map((skill) => (
                                <div key={skill.name} className="bg-[#FBF5F3] text-[#000807] px-4 py-4 rounded-lg shadow-lg flex flex-col items-center hover:scale-105 transition-all">
                                    {skill.icon}
                                    <p className="mt-2 text-center text-sm md:text-base">{skill.name}</p>
                                    <div className="w-full bg-gray-200 rounded-full h-2.5 mt-4">
                                        <div className="bg-[#39A56F] h-2.5 rounded-full" style={{ width: `${skill.progress}%` }}></div>
                                    </div>
                                </div>
                            ))}
                        </div>
            ...
            {/* Projects */}
            {/*<section id="projects" className="px-4 py-12 md:p-16 flex flex-col items-center justify-center" data-aos="fade-left">*/}
            <section id="projects" className="px-4 py-12 md:p-16 flex flex-col items-center justify-center">
                <div className="flex flex-wrap justify-center gap-6 max-w-7xl">
                    ...
                    {[
                        ...
                        <div key={project.title} className="w-full sm:w-[300px] bg-white rounded-xl shadow-md flex flex-col">
                            <div className="h-56 flex items-center justify-center">
                                <img src={project.img} alt={project.title} className="object-contain h-36 w-auto" />
                            </div>
                            <div className="p-6">
                            ...
                            <div className="p-6 pt-0">
                                <Link to={project.to} className="bg-gray-900 text-white text-xs py-3 px-6 rounded-lg hover:shadow-lg block text-center">
                                    Bekijk project
                                </Link>
                            </div>
                        </div>
