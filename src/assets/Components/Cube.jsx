        ...
        <div className="cube-container m-9">
            ...
            <div className="cube-wrapper">
                <div className="cube" style={{ transform: `rotateY(${rotation}deg)` }}>
                    <div className="face front flex flex-col items-center justify-center text-center bg-gray-700 p-5 rounded-lg shadow-lg border border-gray-500">
                        <h2 className="text-xl font-bold text-white mb-2">Gebarentaal oefenen</h2>
                        <img src="/no-photo.jpeg" alt="Project 1" className="w-72 h-48 object-cover rounded-lg mb-2" />
                    ...
                    <div className="face back flex flex-col items-center justify-center text-center bg-gray-700 p-5 rounded-lg shadow-lg border border-gray-500">
                        <h2 className="text-xl font-bold text-white mb-2">School eindopdracht</h2>
                        <img src="/no-photo.jpeg" alt="Project 2" className="w-48 h-32 object-cover rounded-lg mb-2" />
                    ...
                    <div className="face right flex flex-col items-center justify-center text-center bg-gray-700 p-5 rounded-lg shadow-lg border border-gray-500">
                        <h2 className="text-xl font-bold text-white mb-2">Open Hiring </h2>
                        <img src="/no-photo.jpeg" alt="Project 3" className="w-48 h-32 object-cover rounded-lg mb-2" />
                    ...
                    <div className="face left flex flex-col items-center justify-center text-center bg-gray-700 p-5 rounded-lg shadow-lg border border-gray-500">
                        <h2 className="text-xl font-bold text-white mb-2">Open Hiring</h2>
                        <img src="/no-photo.jpeg" alt="Project 4" className="w-48 h-32 object-cover rounded-lg mb-2" />
                        <p className="text-sm text-black">Voor een schoolproject moesten we samenwerken met een echte opdrachtgever. Onze opdrachtgever was iO Digital, die de opdracht namens
                            Open Hiring had verstrekt. iO Digital gaf ons team de taak om een webapplicatie te ontwikkelen voor Open Hiring, waarmee werkgevers vacatures kunnen plaatsen en
                            werkzoekenden op een anonieme en eenvoudige manier kunnen solliciteren.
