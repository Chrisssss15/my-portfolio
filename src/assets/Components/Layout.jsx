      ...
      ></span>
                    ...
                    <nav aria-label="Header Navigation"
                        ...
                        <ul className="flex flex-col gap-y-4 sm:flex-row sm:gap-x-8">
                            ...
                            <li className=""><a className="text-gray-600 hover:text-blue-600" href="/contact">Contact</a></li>

                            {/*<li className="mt-2 sm:mt-0"><a*/}
